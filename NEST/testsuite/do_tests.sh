...
TEST_BASEDIR=${NEST_DOC_DIR:-"/home/christoph/nest-simulator-2.14.0/share/doc/nest"}
...
PYTHON_HARNESS="${NEST_DATA_DIR:-/home/christoph/nest-simulator-2.14.0/share/nest}/extras/do_tests.py"
...
if test "x${TEST_PYNEST}" = xtrue ; then
    ...
    if command -v nosetests >/dev/null 2>&1 && nosetests --with-xunit --xunit-file=/dev/null --where=${TEST_OUTDIR} >/dev/null 2>&1; then
        ...
        nosetests -v --with-xunit --xunit-file=${TEST_OUTDIR}/pynest_tests.xml ${NEST_PYTHON_PREFIX:-/home/christoph/nest-simulator-2.14.0/lib/python2.7/site-packages}/nest/tests ${NEST_PYTHON_PREFIX:-/home/christoph/nest-simulator-2.14.0/lib/python2.7/site-packages}/nest/topology/tests 2>&1 \
