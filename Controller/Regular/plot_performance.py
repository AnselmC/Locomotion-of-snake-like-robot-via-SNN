...
print 'Simulation 3, V-REP steps: ', vrep_steps3
nest_steps3 = np.array(h5f3['steps'], dtype = float)
print 'Simulation 3, NEST steps: ', nest_steps3
...
ax1.set_xlim((0,max(dist_to_middle.size, dist_to_middle2.size, dist_to_middle3.size)))
...
plt.axhline(y=0, linewidth=0.5, color='0.')
plt.hist(dist_to_middle2, bins=b, normed=True, color='r', linewidth=0, orientation=u'horizontal')
...
ax6.set_title('Simulation 3\ne = '+str('{:4.3f}'.format(s3)), loc='left', size='medium', position=(1.1,0.2))
plt.axhline(y=0, linewidth=0.5, color='0.')
plt.hist(dist_to_middle3, bins=b, normed=True, color='r', linewidth=0, orientation=u'horizontal')
