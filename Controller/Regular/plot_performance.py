...
while(int(network_no) not in range(1,4)):
    msg = 'Please choose network type: (1)regular, (2)hidden_separated, (3)hidden_agnostic'
    network_no = raw_input(msg)

network_type = str(network_types[network_no-1])
...
filename = 'performance' + str(test_no) + '.pdf'
