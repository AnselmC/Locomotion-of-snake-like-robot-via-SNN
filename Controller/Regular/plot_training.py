...
# ax4.set_title('Network size 2: V-Rep time steps')
...
# ax5.set_title('Network size 3: NEST time steps')
...
# ax6.set_title('Network size 3: V-Rep time steps')
