...
h5f = h5py.File(filepath + '001' + '/performance_data_2.h5', 'r')
h5f2 = h5py.File(filepath + '002' + '/performance_data_2.h5', 'r')
h5f3 = h5py.File(filepath + '003' + '/performance_data_2.h5', 'r')
