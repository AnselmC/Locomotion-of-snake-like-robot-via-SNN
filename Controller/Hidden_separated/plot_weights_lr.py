...
ax1 = plt.subplot(411)
plt.title('Final left weights', color='0.4', fontsize='10')
...
ax4.set_title('Weights to right neuron', color='0.4', size='10')
...
filename = 'session_' + session_no + '_weights_lr_hidden_separated.png'
