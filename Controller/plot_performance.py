...
h5f = h5py.File(filepath + '001' + '/performance_data.h5', 'r')
h5f2 = h5py.File(filepath + '002' + '/performance_data.h5', 'r')
h5f3 = h5py.File(filepath + '003' + '/performance_data.h5', 'r')

vrep_steps = np.array(h5f['vrep_steps'], dtype = float)
print 'Simulation 1, V-REP steps: ', vrep_steps
nest_steps = np.array(h5f['steps'], dtype = float)
print 'Simulation 1, NEST steps: ', nest_steps
avg_dist_to_middle = np.array(h5f['average_distance_to_middle'], dtype = float)
print 'Simulation 1, Average distance to middle: ', avg_dist_to_middle

vrep_steps2 = np.array(h5f2['vrep_steps'], dtype = float)
print 'Simulation 2, V-REP steps: ', vrep_steps2
nest_steps2 = np.array(h5f2['steps'], dtype = float)
print 'Simulation 2, NEST steps: ', nest_steps2
avg_dist_to_middle2 = np.array(h5f2['average_distance_to_middle'], dtype = float)
print 'Simulation 2, Average distance to middle: ', avg_dist_to_middle2

vrep_steps3 = np.array(h5f3['vrep_steps'], dtype = float)
print 'Simulation 3, V-REP steps: ', vrep_steps2
nest_steps3 = np.array(h5f3['steps'], dtype = float)
print 'Simulation 3, NEST steps: ', nest_steps2
avg_dist_to_middle3 = np.array(h5f3['average_distance_to_middle'], dtype = float)
print 'Simulation 3, Average distance to middle: ', avg_dist_to_middle3
...
ax1.set_xlim((0,dist_to_middle.size))
...
ax2.set_title('e = '+str('{:4.3f}'.format(s1)), loc='left', size='medium', position=(1.1,0.2))
plt.axhline(y=0, linewidth=0.5, color='0.')
plt.hist(dist_to_middle, bins=b, normed=True, color='r', linewidth=2, orientation=u'horizontal')

ax3 = plt.subplot(gs[2])
ax3.set_title('Simulation 2', color='0.4')
...
ax3.plot(dist_to_middle2, linewidth=1.0, color='r')
...
ax4.set_title('e = '+str('{:4.3f}'.format(s2)), loc='left', size='medium', position=(1.1,0.2))
plt.axhline(y=0, linewidth=0.5, color='0.')
plt.hist(dist_to_middle2, bins=b, normed=True, color='r', linewidth=2, orientation=u'horizontal')

ax5 = plt.subplot(gs[4])
ax5.set_title('Simulation 3', color='0.4')
...
ax5.plot(dist_to_middle3, linewidth=1.0, color='r')
...
ax6.set_title('e = '+str('{:4.3f}'.format(s3)), loc='left', size='medium', position=(1.1,0.2))
plt.axhline(y=0, linewidth=0.5, color='0.')
plt.hist(dist_to_middle3, bins=b, normed=True, color='r', linewidth=1, orientation=u'horizontal')
