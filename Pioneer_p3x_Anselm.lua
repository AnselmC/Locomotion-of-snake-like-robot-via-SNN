...
if (sim_call_type==sim_childscriptcall_initialization) then 
    ...
    turning = false
    turnRight = true
    stepsLeft = simGetScriptSimulationParameter(sim_handle_self, "turnLength", true)
...
if (sim_call_type==sim_childscriptcall_actuation) then 
    ...
    if(turning == true) then
        if(stepsLeft == simGetScriptSimulationParameter(sim_handle_self, "turnLength", true)) then 
            turn()
        end
